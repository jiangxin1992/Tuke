...
/** 判断是否为4.7寸屏幕 */
#define kIiPhone6 ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(750, 1334), [[UIScreen mainScreen] currentMode].size) : NO)
/** 判断是否为4英寸屏幕 */
...
/** 判断当前设备是否为iPhone 6以上 */
#define IsPhone6_gt kIPhone6Plus||kIiPhone6
/** 判断当前设备是否为iPhone 5以上 */
#define IsPhone5_gt kIPhone6Plus||kIiPhone6||kIPhone5s
/** 是否是pad */
